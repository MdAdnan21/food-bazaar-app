...
export const RESTAURANT_DATA_API = 'https://food-app-be-gamma.vercel.app/api/restaurant'

export const RESTAURANT_MENU_API = 'https://food-app-be-gamma.vercel.app/api/restaurant/'
